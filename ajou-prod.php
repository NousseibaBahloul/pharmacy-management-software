            ...
            <div class="b">
            	<form action="" method="POST">
	                <table class="table">
				        ...
				        <tr>
				        	<td><label style="font-size:20px;letter-spacing: 3px;font-weight: bold;">Date Expiré :</label></td>
...
if ($ajouter) {
	if ($copr=="" or $nom=="" or $famille=="" or $dosage=="" or $forme=="" or $prix=="" or $expiré=="") {
        ...
        if ($rows==1) {
        	echo '<script>alert("Le code de produit est existe déjà");</script>';
        }
        else{
