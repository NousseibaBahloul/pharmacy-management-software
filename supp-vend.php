...
<body class="body">
		...
		<ul id="father">
			...
			<li> Gérer les vendeurs
				<ul id="son">
					...
					<li style="background-color: #606060;"><a href="supp-vend.php" style="color: #3eb408;font-weight: bold;"> Supprimer vendeur </a></li>
	...
	<div class="content">
		<h1 class="page"> Supprimer vendeur <h1>
        <div class="a">
        	<div class="b">
...
if ($supprimer) {
	if ($idve=="" or $password=="") {
        ...
        if ($rows==0) {
        	...
        	if ($conf == "oui") {
        		$query1=mysql_query("DELETE FROM `vendeur` WHERE id='$idve' AND password='$password'");
        		if ($query1) {
