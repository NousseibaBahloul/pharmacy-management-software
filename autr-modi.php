		        	...
		        	<table class="table">
		        			<tr>
			        			<td colspan="2" style="font-size: 15px">
			        				<label style="font-size:18px;letter-spacing: 3px">Code fournisseur :</label>
...
$n=0;	
	if (isset($_POST['info'])) {
		//echo $lm;
	 	switch ($info) {
	 		case 'nom':
	 			$query = mysql_query("SELECT nom FROM `fournisseur` WHERE codefournisseur='$lm'") ;
	    		...
	    		$c=$row->nom; 			
	 			...
	 			break;
	 		case 'prénom':
	 			$query = mysql_query("SELECT prénom FROM `fournisseur` WHERE codefournisseur='$lm'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->prénom; 			
	 			echo ($c);
	 			$n=2;
	 			...
	 			break;	 			
	 		case 'ville':
	 			$query = mysql_query("SELECT ville FROM `fournisseur` WHERE codefournisseur='$lm'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->ville; 			
	 			echo ($c);
	 			$n=3;
	 			...
	 			break;
	 		case 'tel':
	 			$query = mysql_query("SELECT téléphon FROM `fournisseur` WHERE codefournisseur='$lm'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->téléphon; 			
	 			echo ($c);
	 			$n=4;
	 			...
	 			break;
	 		case 'fax':
	 			$query = mysql_query("SELECT fax FROM `fournisseur` WHERE codefournisseur='$lm'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->fax; 			
	 			echo ($c);
	 			$n=5;
	 			...
	 			break;
	 		case 'email':
	 			$query = mysql_query("SELECT email FROM `fournisseur` WHERE codefournisseur='$lm'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->email; 			
	 			echo ($c);
	 			$n=6;
	 			...
	 			break;			
	 		case 'adresse':
	 			$query = mysql_query("SELECT adresse FROM `fournisseur` WHERE codefournisseur='$lm'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->adresse; 			
	 			echo ($c);
	 			$n=7;
