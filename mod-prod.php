...
<html>
<head>
	<title>Modifier produitAfficher les roduits périmés</title>
...
<body class="body">
		...
		<ul id="father">
			...
			<li> Gérer les produits
				<ul id="son">
					...
					<li style="background-color: #606060;"><a href="mod-prod.php" style="color: #3eb408;font-weight: bold;"> Modifier produit </a></li>
	...
	<div class="content">
		<h1 class="page"> Modifier produit <h1>
        <div class="a">
        	<div class="b">
...
$n=0;	
	if (isset($_POST['info'])) {
	 	switch ($info) {
	 		case 'nom':
	 			$query = mysql_query("SELECT nom FROM `produit` WHERE codeproduit='$copr'") ;
	    		...
	    		$c=$row->nom; 			
	 			...
	 			break;
	 		case 'famille':
	 			$query = mysql_query("SELECT nom_famille FROM `produit` WHERE codeproduit='$copr'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->nom_famille; 			
	 			echo ($c);
	 			$n=2;
	 			...
	 			break;	 			
	 		case 'dosage':
	 			$query = mysql_query("SELECT dosage FROM `produit` WHERE codeproduit='$copr'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->dosage; 			
	 			echo ($c);
	 			$n=3;
	 			...
	 			break;
	 		case 'quantité':
	 			$query = mysql_query("SELECT quantité FROM `produit` WHERE codeproduit='$copr'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->quantité; 			
	 			echo ($c);
	 			$n=4;
	 			...
	 			break;
	 		case 'forme':
	 			$query = mysql_query("SELECT forme FROM `produit` WHERE codeproduit='$copr'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->forme; 			
	 			echo ($c);
	 			$n=5;
	 			...
	 			break;
	 		case 'prix':
	 			$query = mysql_query("SELECT prix_ppa FROM `produit` WHERE codeproduit='$copr'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->prix_ppa; 			
	 			echo ($c);
	 			$n=6;
	 			...
	 			break;			
	 		case 'expiré':
	 			$query = mysql_query("SELECT date_expiré FROM `produit` WHERE codeproduit='$copr'") ;
				$row=mysql_fetch_object($query);
	    		$c=$row->date_expiré; 			
	 			echo ($c);
	 			$n=7;
...
//echo $_SESSION["n"];
		if($_SESSION["n"]==1){
			$ll=$_SESSION["copr"];
			$query = mysql_query("UPDATE `produit` SET `nom` = '$modi' WHERE `codeproduit`= '$ll'");
			if ($query) {
if ($autr == 'oui') {
	...
	header("location:mod-prod.php");		
		...
		elseif($_SESSION["n"]==2){
			$ll=$_SESSION["copr"];
			$query = mysql_query("UPDATE `produit` SET `nom_famille` = '$modi' WHERE `codeproduit`= '$ll'");
			if ($query) {
if ($autr == 'oui') {
	header("location:autr-modi2.php");
}
	...
	header("location:mod-prod.php");		
		...
		elseif($_SESSION["n"]==3){
			$ll=$_SESSION["copr"];
			$query = mysql_query("UPDATE `produit` SET `dosage` = '$modi' WHERE `codeproduit`= '$ll'");
			if ($query) {
if ($autr == 'oui') {
	header("location:autr-modi2.php");
}
	...
	header("location:mod-prod.php");		
		...
		elseif($_SESSION["n"]==4){
			$ll=$_SESSION["copr"];
			$query = mysql_query("UPDATE `produit` SET `quantité` = '$modi' WHERE `codeproduit`= '$ll'");
			if ($query) {
if ($autr == 'oui') {
	header("location:autr-modi2.php");
}
	...
	header("location:mod-prod.php");		
		...
		elseif($_SESSION["n"]==5){
			$ll=$_SESSION["copr"];
			$query = mysql_query("UPDATE `produit` SET `forme` = '$modi' WHERE `codeproduit`= '$ll'");
			if ($query) {
if ($autr == 'oui') {
	header("location:autr-modi2.php");
}
	...
	header("location:mod-prod.php");		
		...
		elseif($_SESSION["n"]==6){
			$ll=$_SESSION["copr"];
			$query = mysql_query("UPDATE `produit` SET `prix_ppa` = '$modi' WHERE `codeproduit`= '$ll'");
			if ($query) {
if ($autr == 'oui') {
	header("location:autr-modi2.php");
}
	...
	header("location:mod-prod.php");		
		...
		elseif($_SESSION["n"]==7){
			$ll=$_SESSION["copr"];
			$query = mysql_query("UPDATE `produit` SET `date_expiré` = '$modi' WHERE `codeproduit`= '$ll'");
			if ($query) {
if ($autr == 'oui') {
	header("location:autr-modi2.php");
}
