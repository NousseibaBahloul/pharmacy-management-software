...
<body class="body">
		...
		<ul id="father">
            ...
            <li> Gérer les produits
                <ul id="son">
                    ...
                    <li style="background-color: #606060;"><a href="prod-expi.php" style="color: #3eb408;font-weight: bold;"> Afficher les produits périmés </a></li>                 
                </ul>
            </li>
	...
	<div class="content">
		<h1 class="page"> Afficher les produits périmés <h1>
        <div class="a" style="margin-left: 160px">
        	<table class="table">
        		<form method="POST" action="">
			        <tr>
				        <td style="width: 35%">
				        	<label style="font-size: 20px;margin-left: 70px"> Date spécifiée  :</label>
						</td>
						<td style="width: 40%">
				        	<input type="date" name="date" style="margin-right: 60px;">
	        			</td>
						<td style="width: 25%">
...
$_SESSION['dada']=$date;
//echo $date;
$query=mysql_query("SELECT * FROM `produit` WHERE `date_expiré`<='$date'");
